...
namespace P89Q49_3_11_22
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            char y1 = 'u', y2 = 'u', y3 = 'u', y4 = 'u', y5 = 'u', y6 = 'u', y7 = 'u', y8 = 'u', y9 = 'u';
            int num1, num2, num3;

            Console.WriteLine("Enter the number of the first card chosen");
            num1 = int.Parse(Console.ReadLine());
            Console.WriteLine("Enter the number of the Second card chosen");
            num2 = int.Parse(Console.ReadLine());
            Console.WriteLine("Enter the number of the Third card chosen");
            ...
            if ((y1 == 'y' && y2 == 'y' && y3 == 'y') || (y4 == 'y' && y5 == 'y' && y6 == 'y') ||
                (y7 == 'y' && y8 == 'y' && y9 == 'y') || (y1 == 'y' && y4 == 'y' && y7 == 'y') ||
                (y2 == 'y' && y5 == 'y' && y8 == 'y') || (y3 == 'y' && y6 == 'y' && y9 == 'y'))
            {
                Console.WriteLine("The kid gets a present, he answered a whole row right");
            }
            else
            {
                Console.WriteLine("The kid didn't get a present, he didn't answer a whole row right");
            }
            if (( y1 == 'y' || y2 == 'y' || y3 == 'y') && (y4 == 'y' || y5 == 'y' || y6 == 'y') && (y7 == 'y' || y8 == 'y' || y9 == 'y') )
            {
                Console.WriteLine("The kid gets a present,he answered one riddle per row correctly");
            }
            else
            {
                Console.WriteLine("The kid didn't get a present,he didn't answer one riddle per row correctly");
            }
        }
    }
}
